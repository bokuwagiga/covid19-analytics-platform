...
layout = dbc.Container([
    ...
    dbc.Row([
        ...
        CommentsSection("infection-cases", country_dropdown_id="cases-country-dropdown")
    ])
], fluid=True)
...
register_comment_callbacks("infection-cases", country_dropdown_id="cases-country-dropdown")
